...
Begin VB.Form Frm_PrefectPosts 
   BackColor       =   &H00CFE1E2&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "App Title : Prefect Posts"
   ClientHeight    =   3075
   ClientLeft      =   45
   ClientTop       =   735
   ClientWidth     =   4935
   Icon            =   "Frm_PrefectPosts.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   3075
   ...
   Begin Stadmis.ShapeButton ShpBttnMove 
      ...
      Caption         =   ""
      Picture         =   "Frm_PrefectPosts.frx":09EA
   ...
   Begin Stadmis.ShapeButton ShpBttnMove 
      ...
      BorderColorHover=   11632444
      Caption         =   ""
      Picture         =   "Frm_PrefectPosts.frx":0F84
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin Stadmis.ShapeButton ShpBttnMove 
      ...
      BorderColorHover=   11632444
      Caption         =   ""
      Picture         =   "Frm_PrefectPosts.frx":131E
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin Stadmis.ShapeButton ShpBttnBriefNotes 
      ...
      Caption         =   "      Brief Notes"
      AccessKey       =   "B"
      Picture         =   "Frm_PrefectPosts.frx":18B8
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   Begin VB.CommandButton CmdMoveRec 
      ...
      Index           =   3
      Left            =   4440
      Picture         =   "Frm_PrefectPosts.frx":1C52
      Style           =   1  'Graphical
      TabIndex        =   13
   ...
   Begin VB.CommandButton CmdMoveRec 
      ...
      Index           =   2
      Left            =   4080
      Picture         =   "Frm_PrefectPosts.frx":1F94
      Style           =   1  'Graphical
      TabIndex        =   12
   ...
   Begin VB.CommandButton CmdMoveRec 
      ...
      Index           =   1
      Left            =   3720
      Picture         =   "Frm_PrefectPosts.frx":22D6
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.CommandButton CmdMoveRec 
      ...
      Index           =   0
      Left            =   3360
      Picture         =   "Frm_PrefectPosts.frx":2618
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.ListBox LstItems 
      ...
      Width           =   4092
   End
   Begin VB.Frame Fra_PrefectPost 
      BackColor       =   &H00CFE1E2&
      Height          =   2172
      Left            =   120
      TabIndex        =   15
      Top             =   120
      Width           =   4695
      Begin MSComCtl2.UpDown udSeats 
         Height          =   315
         Left            =   3000
         TabIndex        =   17
         TabStop         =   0   'False
   ...
   Begin VB.Image ImgHeader 
      Height          =   255
      Left            =   0
      Picture         =   "Frm_PrefectPosts.frx":295A
      Stretch         =   -1  'True
      Top             =   -120
      Width           =   5055
   End
   Begin VB.Image ImgFooter 
      Height          =   735
      Left            =   0
      Picture         =   "Frm_PrefectPosts.frx":3150
      Stretch         =   -1  'True
      Top             =   2400
      Width           =   5055
   End
   ...
   End
End
Attribute VB_Name = "Frm_PrefectPosts"
...
On Local Error GoTo Handle_LockEntries_Error
    ...
    Fra_PrefectPost.Enabled = Not State
...
On Local Error GoTo Handle_DisplayRecord_Error
    ...
    With vRs 'Execute a series of statements on vRs recordset
        ...
        If Not (.BOF And .EOF) Then
            ...
            If Not VBA.IsNull(![Seats]) Then txtSeats.Text = ![Seats]
...
Private Sub MnuEdit_Click()
    ...
    If txtName.Tag = VBA.vbNullString Then
        ...
        'Warn User to select an existing Record
        vMsgBox "Please display a Record.", vbExclamation, App.Title & " : No Record Displayed", Me
        If Fra_PrefectPost.Enabled Then txtName.SetFocus 'Move the focus to the specified control
...
On Local Error GoTo Handle_MnuSearch_Click_Error
    ...
    vBuffer(&H0) = PickDetails(Me, "SELECT [" & myTableFixedFldName(&H0) & " ID], [" & myTableFixedFldName(&H0) & " Name], [Seats] FROM " & myTableFixedFldName(&H4) & " ORDER BY [Hierarchical Level] ASC, [" & myTableFixedFldName(&H0) & " Name] ASC", txtName.Tag, , "1", , , myTableFixedFldName(&H3))
...
Private Sub ShpBttnBriefNotes_Click()
    ...
    Call OpenNotes(ShpBttnBriefNotes, Not Fra_PrefectPost.Enabled, myTableFixedFldName(&H2))
End Sub
...
Private Sub txtSeats_Change()
    'Prevent empty content
    txtSeats.Text = VBA.IIf(txtSeats.Text = VBA.vbNullString, udSeats.Min, txtSeats.Text)
    txtSeats.SelStart = VBA.Len(txtSeats.Text)
End Sub

Private Sub txtSeats_KeyPress(KeyAscii As Integer)
    'Discard non-numeric entries
    KeyAscii = VBA.IIf(((KeyAscii >= 33 And KeyAscii <= 47) Or (KeyAscii >= 58 And KeyAscii <= 95) Or (KeyAscii >= 106 And KeyAscii <= 126)), KeyAscii = Empty, KeyAscii): If KeyAscii = Empty Then VBA.Beep
End Sub
